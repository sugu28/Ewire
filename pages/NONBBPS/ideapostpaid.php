                                    ...
                                    <table class="table" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            if ($_SESSION['User_RoleID'] == 1) {
                                                ...
                                                $res = mysqli_query($db, "SELECT * FROM tbl_Non_BBPS_Billers WHERE kioskid = (SELECT Kioskid FROM tblMasterDistributor WHERE UserID = '$uid')");
                                                ...
                                                $res = mysqli_query($db, "SELECT * FROM tbl_Non_BBPS_Billers WHERE kioskid = (SELECT Kioskid FROM tblRetailer WHERE UserID = '$uid')");
                                            }
