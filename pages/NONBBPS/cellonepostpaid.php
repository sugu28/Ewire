                                    ...
                                    <table class="table" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            if (isset($_GET['from_date']) && isset($_GET['to_date'])) {
                                                ...
                                                $filterQry = "AND TransactionDate BETWEEN '$from_date' AND '$tt'";
                                            }
                                            ...
                                            if ($_SESSION['User_RoleID'] == 1) {
                                                ...
                                                WHERE kioskDetail.UserId = '$uid' AND kioskDetail.IsActive = 1 " . $filterQry . " ORDER BY tblCyberPlatCashTransfer.TransactionDate DESC");
                                            } elseif ($_SESSION['User_RoleID'] == 2) {
                                                $res = mysqli_query($db, "SELECT * FROM tbl_Non_BBPS_Billers WHERE kioskid = (SELECT Kioskid FROM tblMasterDistributor WHERE UserID = '$uid' " . $filterQry . " ORDER BY tblCyberPlatCashTransfer.TransactionDate DESC)");
                                                ...
                                                WHERE tblDistributor.UserID = '$uid' " . $filterQry . " ORDER BY tblCyberPlatCashTransfer.TransactionDate DESC");
                                            } elseif ($_SESSION['User_RoleID'] == 4) {
                                                $res = mysqli_query($db, "SELECT * FROM tbl_Non_BBPS_Billers WHERE kioskid = (SELECT Kioskid FROM tblRetailer WHERE UserID = '$uid' " . $filterQry . "ORDER BY tblCyberPlatCashTransfer.TransactionDate DESC)");
                                            }
