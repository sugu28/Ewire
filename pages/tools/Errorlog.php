                                    ...
                                    <table class="table" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            if (isset($_GET['from_date']) && isset($_GET['to_date'])) {
                                                ...
                                                $filterQry = "AND created_time BETWEEN '$from_date' AND '$tt'";
                                            }
                                            ...
                                            if ($_SESSION['User_RoleID'] == 1) {
                                                ...
                                                $res = mysqli_query($db, "SELECT tb_Error_logs.* FROM tb_Error_logs INNER JOIN tblRetailer ON
                                                tb_Error_logs.kioskid = tblRetailer.kioskId INNER JOIN tblMasterDistributor ON
                                                 tblRetailer.MAsterDistributorID = tblMasterDistributor.Id 
                                                WHERE tblMasterDistributor.UserID = '$uid'" . $filterQry . " ORDER BY tb_Error_logs.created_time DESC");
                                                ...
                                                $res = mysqli_query($db, "SELECT * FROM tb_Error_logs WHERE KioskId = '$kioID' " . $filterQry . "ORDER BY tb_Error_logs.created_time DESC");
                                            }
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;"><?php echo $row["Screen"]; ?></td>
                                                    <td style="text-align: center;"><?php echo $row["function_name"]; ?></td>
                                                    <td style="text-align: center;"><?php echo $row["Error"]; ?></td>
