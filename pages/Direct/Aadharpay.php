...
-->
                                <?php if ($_SESSION['User_RoleName'] == 'Super Admin' || $_SESSION['User_RoleName'] == 'Master Distributor') {  ?> <li class="nav-item"> <a class="nav-link" href="pages/Reports/Commission.php">Commission History</a></li> <?php                 }                 ?>
                                    ...
                                    <table class="table" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            if ($_SESSION['User_RoleID'] == 1) {
                                                $res = mysqli_query($db, "SELECT tbl_aeps_trans_details.* FROM tbl_aeps_trans_details INNER JOIN kioskDetail ON tbl_aeps_trans_details.kioskid = kioskDetail.KioskID 
                                                WHERE kioskDetail.UserId = '$uid' AND kioskDetail.IsActive = 1  ORDER BY tbl_aeps_trans_details.transdatetime DESC");
                                            } elseif ($_SESSION['User_RoleID'] == 2) {
                                                $res = mysqli_query($db, "SELECT tbl_aeps_trans_details.* FROM tbl_aeps_trans_details INNER JOIN tblRetailer ON tbl_aeps_trans_details.kioskid = tblRetailer.kioskId INNER JOIN tblMasterDistributor ON tblRetailer.MAsterDistributorID = tblMasterDistributor.Id 
                                                WHERE tblMasterDistributor.UserID = '$uid' ORDER BY tbl_aeps_trans_details.transdatetime DESC");
                                            } elseif ($_SESSION['User_RoleID'] == 3) {
                                                $res = mysqli_query($db, "SELECT tbl_aeps_trans_details.* FROM tbl_aeps_trans_details INNER JOIN tblRetailer ON tbl_aeps_trans_details.kioskid = tblRetailer.kioskId INNER JOIN tblDistributor ON tblRetailer.DistributorID = tblDistributor.Id 
                                                WHERE tblDistributor.UserID = '$uid' ORDER BY tbl_aeps_trans_details.transdatetime DESC");
                                            } elseif ($_SESSION['User_RoleID'] == 4) {
                                                $res = mysqli_query($db, "SELECT * FROM tbl_aeps_trans_details WHERE kioskid = (SELECT Kioskid FROM tblRetailer WHERE UserID = '$uid') ORDER BY tbl_aeps_trans_details.transdatetime DESC");
                                            }
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;"><?php echo $row["transdatetime"]; ?></td>
                                                    <td style="text-align: center;"><?php echo $row["serviceProviderId"]; ?></td>
                                                    <td style="text-align: center;"><?php echo $row["totalAmount"]; ?></td>
                                                    <td style="text-align: center;"><?php echo $row["amount"]; ?></td>
                                                    <td style="text-align: center;"><?php echo $row["retailerId"]; ?></td>
                                                    <td style="text-align: center;"><?php echo $row["transactionId"]; ?></td>
                                                    <td style="text-align: center;"><?php echo $row["transactionType"]; ?></td>
                                                    <td style="text-align: center;"><?php echo $row["allowed"]; ?></td>
                                                    <td style="text-align: center;"><?php echo $row["OperatorTransID"]; ?></td>
                                                    <td style="text-align: center;"><?php echo $row["DealerTransID"]; ?></td>
