...
<head>
    ...
    <title>Manual Entry Transactions</title>
    <!-- Tables -->
...
-->
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="BBPSBILLERS">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="../BBPSBILLERS/Airtel.php">Airtel</a></li>
                                <li class="nav-item"> <a class="nav-link" href="../BBPSBILLERS/Bsnl.php">Bsnl</a></li>
                                <li class="nav-item"> <a class="nav-link" href="../BBPSBILLERS/Idea.php">Idea</a></li>
                                <li class="nav-item"> <a class="nav-link" href="../BBPSBILLERS/Jio.php">Jio</a></li>
                                <li class="nav-item"> <a class="nav-link" href="../BBPSBILLERS/MTNLMumbai.php">MTNL Mumbai</a></li>
                                <li class="nav-item"> <a class="nav-link" href="../BBPSBILLERS/MTNLDelhi.php">MTNL Delhi</a></li>
                                <li class="nav-item"> <a class="nav-link" href="../BBPSBILLERS/Vodafone.php">Vodafone</a></li>
                                <li class="nav-item"> <a class="nav-link" href="../BBPSBILLERS/AirtelDTH.php">Airtel DTH</a></li>
                                <li class="nav-item"> <a class="nav-link" href="../BBPSBILLERS/DishTV.php">Dish TV</a></li>
                                <li class="nav-item"> <a class="nav-link" href="../BBPSBILLERS/Sundirect.php">Sundirect</a></li>
                                <li class="nav-item"> <a class="nav-link" href="../BBPSBILLERS/TataskyRetails.php">Tatasky Retails</a></li>
                                <li class="nav-item"> <a class="nav-link" href="../BBPSBILLERS/TataskyOnline.php">Tatasky Online</a></li>
                                <li class="nav-item"> <a class="nav-link" href="../BBPSBILLERS/VideoconD2H.php">Videocon D2H</a></li>
                                <li class="nav-item"> <a class="nav-link" href="../BBPSBILLERS/VodafoneDatacard.php">Vodafone Datacard</a></li>
                                <li class="nav-item"> <a class="nav-link" href="../BBPSBILLERS/AirtelDatacard.php">Airtel Datacard</a></li>
                                <li class="nav-item"> <a class="nav-link" href="../BBPSBILLERS/Ideadatacard.php">Idea data card</a></li>
                                <li class="nav-item"> <a class="nav-link" href="../BBPSBILLERS/Electricity.php">Electricity</a></li>
                                <li class="nav-item"> <a class="nav-link" href="../BBPSBILLERS/Gas.php">Gas</a></li>
                                <li class="nav-item"> <a class="nav-link" href="../BBPSBILLERS/Water.php">Water</a></li>
                                <li class="nav-item"> <a class="nav-link" href="../BBPSBILLERS/TelecomMobileAndLandline.php">Telecom Mobile And Landline Post Paid Online</a></li>
                                <li class="nav-item"> <a class="nav-link" href="../BBPSBILLERS/TelecomMobilepostpaid.php">Telecom Mobile And Landline Post Retails</a></li>
...
-->
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <form action="awaiting.php" method="POST">
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <table class="table" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                if (isset($_GET['from_date']) && isset($_GET['to_date'])) {
                                                    ...
                                                    $filterQry = "AND trans_datetime BETWEEN '$from_date' AND '$tt'";
                                                }

                                                if ($_SESSION['User_RoleID'] == 1) {
                                                    $res = mysqli_query($db, "SELECT * FROM tblCyberPlatCashTransfer INNER JOIN kioskDetail ON tblCyberPlatCashTransfer.kioskid = kioskDetail.kioskId WHERE (tblCyberPlatCashTransfer.TransferStatus='Awaiting' OR tblCyberPlatCashTransfer.TransferStatus='Pending' 
                                                    OR tblCyberPlatCashTransfer.TransferStatus='Sent' OR tblCyberPlatCashTransfer.TransferStatus='Inprogress' OR tblCyberPlatCashTransfer.TransferStatus='Decision Pending' OR tblCyberPlatCashTransfer.TransferStatus='Retrying') AND kioskDetail.IsActive = 1 " . $filterQry . " ORDER BY tblCyberPlatCashTransfer.trans_datetime DESC");
                                                } elseif ($_SESSION['User_RoleID'] == 2) {
                                                    $res = mysqli_query($db, "SELECT tblCyberPlatCashTransfer.* FROM tblCyberPlatCashTransfer INNER JOIN tblRetailer ON tblCyberPlatCashTransfer.kioskid = tblRetailer.kioskId INNER JOIN tblMasterDistributor ON tblRetailer.MasterDistributorID = tblMasterDistributor.Id WHERE 
                                                    (tblCyberPlatCashTransfer.TransferStatus='Awaiting' OR tblCyberPlatCashTransfer.TransferStatus='Pending' OR tblCyberPlatCashTransfer.TransferStatus='Sent' OR tblCyberPlatCashTransfer.TransferStatus='Inprogress' 
                                                    OR tblCyberPlatCashTransfer.TransferStatus='Decision Pending' OR tblCyberPlatCashTransfer.TransferStatus='Retrying') AND tblMasterDistributor.UserID = '$uid' " . $filterQry . " ORDER BY tblCyberPlatCashTransfer.trans_datetime DESC");
                                                } elseif ($_SESSION['User_RoleID'] == 3) {
                                                    $res = mysqli_query($db, "SELECT tblCyberPlatCashTransfer.* FROM tblCyberPlatCashTransfer INNER JOIN tblRetailer ON tblCyberPlatCashTransfer.kioskid = tblRetailer.kioskId INNER JOIN tblDistributor ON tblRetailer.DistributorID = tblDistributor.Id tblCyberPlatCashTransfer.TransferStatus='Awaiting' AND WHERE tblDistributor.UserID = '$uid' " . $filterQry . " ORDER BY tblCyberPlatCashTransfer.trans_datetime DESC");
                                                } elseif ($_SESSION['User_RoleID'] == 4) {
                                                    $res = mysqli_query($db, "SELECT * FROM tblCyberPlatCashTransfer WHERE tblCyberPlatCashTransfer.TransferStatus='Awaiting' AND kioskid = (SELECT Kioskid FROM tblRetailer WHERE UserID = '$uid' " . $filterQry . " ) ORDER BY tblCyberPlatCashTransfer.trans_datetime DESC");
                                                }
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center;"><button class="btn btn-square btn-sm btn-outline-success btn-icon-text" name="success" value="<?php echo $kfw . "," . $row["name"] . "," . $row["trans_datetime"] . "," . $row["amount"] ?>">Success</button></td>
                                                        <td style="text-align: center;"><button class="btn btn-square btn-sm btn-outline-danger btn-icon-text" name="Failed" value="<?php echo $kfw . "," . $row["name"] . "," . $row["trans_datetime"] . "," . $row["amount"] ?>">Failed</button></td>
                                            ...
                                            $('table').DataTable({
                                                ...
                                                buttons: [
                                                    ...
                                                    'csvHtml5',
                                                    {
                                                        ...
                                                        text: ' PDF ',
                                                        titleAttr: 'PDF',
                                                        messageBottom: 'this is the last page'
                                                    }
                                                ]
                                            });
                                        </script>
                                        ...
                                        if (isset($_POST['success'])) {
                                            ...
                                            $query    = "UPDATE `tblCyberPlatCashTransfer` SET TransferStatus = 'Success',manualEntry = '1' WHERE CashauditID = '$str_arr[0]' AND name = '$str_arr[1]' AND trans_datetime = '$str_arr[2]' ";
                                            $result   = mysqli_query($db, $query);
                                            if ($result) {
                                                $query2    = "UPDATE `tbl_Transaction_Status` SET TransferStatus = 'Success',Is_manual='1' WHERE CashauditID = '$str_arr[0]' AND name = '$str_arr[1]' AND amount = '$str_arr[3]' ";
                                                $result2   = mysqli_query($db, $query2);
                                                // $query5 = "INSERT INTO tbl_manual_entry_transactions (kioskid,RemitterPhone,TotalAmount,Credit_OR_Debit,transaction_type,BeneficiaryPhone,BeneficiaryName,Journal_ID)
                                                // VALUES ('$kid1','$remphone','$amount1','DEBIT','TRANSACTION REVERSAL',$benephone1,'$name1','$id1')";
                                                // $result5   = mysqli_query($db, $query5);
                                                echo "<script>Updated();</script>";
                                                echo "<script>location.href='awaiting.php'; </script>";
                                            }
                                        } else if (isset($_POST['Failed'])) {
                                            $ID = strval($_POST['Failed']);
                                            $str_arr = explode(",", $ID);
                                            $query    = "UPDATE `tblCyberPlatCashTransfer` SET TransferStatus = 'Failure',manualEntry = '1' WHERE CashauditID = '$str_arr[0]' AND name = '$str_arr[1]' AND trans_datetime = '$str_arr[2]' ";
                                            $result   = mysqli_query($db, $query);
                                            $query_1    = "SELECT * FROM tbl_Journal_Ledger WHERE cashauidit_id = '$str_arr[0]' AND beneficiary_Name = '$str_arr[1]' AND trans_datetime = '$str_arr[2]' ";
                                            $res1  = mysqli_query($db, $query_1);
                                            while ($row = mysqli_fetch_array($res1)) {
                                                $id1 = $row['Id'];
                                                $bcid1 = $row['bcid'];
                                                $remphone = $row['RemitterPhone'];
                                                $benephone1 = $row['beneficiary_Phone'];
                                                $amount1 = $row['trans_amount'];
                                                $cred_or_debt = $row['Credit_OR_Debit'];
                                                $name1 =  $row['beneficiary_Name'];
                                                $kid1 = $row['kioskid'];
                                                $accountno = $row['beneficiary_account_No'];
                                                if ($cred_or_debt == 'DEBIT') {
                                                    //echo  "<script>alert('Message Sent to '$amount1');</script>";

                                                    $query2    = "UPDATE `tblRetailer` SET Available_Balance = Available_Balance + '$amount1' WHERE kioskId = '$kid1'";
                                                    $result2   = mysqli_query($db, $query2);

                                                    $query3   = "SELECT * FROM tblRetailer WHERE kioskId = '$kid1'";
                                                    $res3  = mysqli_query($db, $query3);
                                                    while ($row = mysqli_fetch_array($res3)) {
                                                        $bal =  $row['Available_Balance'];
                                                    }
                                                    $query4 = "INSERT INTO tbl_Journal_Ledger (bcid,kioskid,RemitterPhone,trans_amount,Credit_OR_Debit,transaction_type,balance,beneficiary_Phone,beneficiary_Name,beneficiary_account_No,cashauidit_id,manualEntry)
                                                            VALUES ('$bcid1 ','$kid1','$remphone','$amount1','CREDIT','TRANSACTION REVERSAL','$bal',$benephone1,'$name1','$accountno','$str_arr[0]','1')";
                                                    $result4  = mysqli_query($db, $query4);
                                                    if ($result4) {
                                                        $query5 = "INSERT INTO tbl_manual_entry_transactions (kioskid,RemitterPhone,TotalAmount,Credit_OR_Debit,transaction_type,BeneficiaryPhone,BeneficiaryName,Journal_ID)
                                                    VALUES ('$kid1','$remphone','$amount1','CREDIT','TRANSACTION REVERSAL',$benephone1,'$name1','$id1')";
                                                        $result5   = mysqli_query($db, $query5);
                                                    }
                                                } else if ($cred_or_debt == 'CREDIT') {
                                                    ...
                                                    //echo  "<script>alert('Message Sent to '$bal ');</script>";
                                                    $query4 = "INSERT INTO tbl_Journal_Ledger (bcid,kioskid,RemitterPhone,trans_amount,Credit_OR_Debit,transaction_type,balance,beneficiary_Phone,beneficiary_Name,beneficiary_account_No,cashauidit_id,manualEntry)
                                                                VALUES ('$bcid1 ','$kid1','$remphone','$amount1','DEBIT','TRANSACTION REVERSAL','$bal',$benephone1,'$name1','$accountno','$str_arr[0]','1')";
                                                    $result4  = mysqli_query($db, $query4);
                                                    if ($result4) {
                                                        $query5 = "INSERT INTO tbl_manual_entry_transactions (kioskid,RemitterPhone,TotalAmount,Credit_OR_Debit,transaction_type,BeneficiaryPhone,BeneficiaryName,Journal_ID)
                                                                    VALUES ('$kid1','$remphone','$amount1','DEBIT','TRANSACTION REVERSAL',$benephone1,'$name1','$id1')";
                                                ...
                                                $query2    = "UPDATE `tbl_Transaction_Status` SET TransferStatus = 'Failure',Is_yapay_done ='0',Is_journal_done = '0',Is_trans_failed = '1',Is_manual='1' WHERE CashauditID = '$str_arr[0]' AND name = '$str_arr[1]' AND amount = '$str_arr[3]'";
                                                $result2   = mysqli_query($db, $query2);
                                                echo "<script>Updated();</script>";
                                                echo "<script>location.href='awaiting.php'; </script>";
                                                //echo  "<script>alert('Message Sent to '$amount1');</script>";
