...
-->
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <form action="Allbankcashdeposit.php" method="POST">
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <table class="table" style="width:100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <!-- <th style="text-align: center;">CameraCapture</th> -->
                                                </tr>
                                            </thead>
                                            <tbody>
                                                ...
                                                function displayImageFromDatabase1()
                                                {
                                                    $CameraCapture = '';
                                                    //use global keyword to declare conn inside a function
                                                    global $db;
                                                    $sqlselectimageFromDb = "SELECT CameraCapture FROM `tblCyberPlatCashTransfer` where Id=169";
                                                    $dataFromDb = mysqli_query($db, $sqlselectimageFromDb);
                                                    while ($row = mysqli_fetch_assoc($dataFromDb)) {
                                                        $CameraCapture =  $row["CameraCapture"];
                                                        $encoded_image = base64_encode($CameraCapture);

                                                        //    $encoded_image = base64_encode($CameraCapture); 
                                                        // echo '<img height="250px" width="250px" src=data:image;base64,"'.$row["image"].'"/>';
                                                        // echo '<img height="250px" width="250px" src=data:image;base64,'.$row&#91;'image'&#93;.'/>';
                                                        //                                                echo '<img height="250px" width="250px" src="data:CameraCapture/png;base64, UklGRsJQAwBXRUJQVlA4ILZQAwAQ8widASovBpcCPkkgjUUioi" alt="Red dot" />';
                                                ...
                                                if ($_SESSION['User_RoleID'] == 1) {
                                                    $res = mysqli_query($db, "SELECT  * FROM tblCyberPlatCashTransfer INNER JOIN kioskDetail ON tblCyberPlatCashTransfer.kioskid = kioskDetail.kioskId WHERE kioskDetail.IsActive = 1 " . $filterQry . " ORDER BY tblCyberPlatCashTransfer.trans_datetime DESC");
                                                ...
                                                WHERE tblMasterDistributor.UserID = '$uid' " . $filterQry . " ORDER BY tblCyberPlatCashTransfer.trans_datetime DESC");
                                                ...
                                                WHERE tblDistributor.UserID = '$uid' " . $filterQry . " ORDER BY tblCyberPlatCashTransfer.trans_datetime DESC");
                                                } elseif ($_SESSION['User_RoleID'] == 4) {
                                                    $res = mysqli_query($db, "SELECT * FROM tblCyberPlatCashTransfer WHERE kioskid = (SELECT Kioskid FROM tblRetailer WHERE UserID = '$uid' " . $filterQry . " ) ORDER BY tblCyberPlatCashTransfer.trans_datetime DESC");
                                                }
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php } ?>
                                                        <!-- <td><?php if ($row["CameraCapture"] != null) {
                                                                        echo '<img height="250px" width="250px" src="data:CameraCapture/png;base64, 
                                                   ' . $row["CameraCapture"] . ' " alt="NA" />';
                                                                    } ?> </td> -->
                                                        <!-- <td><?php
                                                            echo "<a href='download.php?val=" . $row["id"] . "'>Download</a>"; ?> </td> -->
                                                    </tr>
                                                <?php
                                                }
                                        ...
                                        <?php
                                        if ($_SESSION['User_RoleID'] == 1) {
                                            $res = mysqli_query($db, "SELECT  SUM(amount) as Total FROM tblCyberPlatCashTransfer INNER JOIN kioskDetail ON tblCyberPlatCashTransfer.kioskid = kioskDetail.kioskId WHERE kioskDetail.IsActive = 1 " . $filterQry . " ORDER BY tblCyberPlatCashTransfer.trans_datetime DESC");
                                        } elseif ($_SESSION['User_RoleID'] == 2) {
                                            $res = mysqli_query($db, "SELECT SUM(amount) as Total FROM tblCyberPlatCashTransfer INNER JOIN tblRetailer ON tblCyberPlatCashTransfer.kioskid = tblRetailer.kioskId INNER JOIN tblMasterDistributor ON tblRetailer.MAsterDistributorID = tblMasterDistributor.Id 
                                        WHERE tblMasterDistributor.UserID = '$uid' " . $filterQry . " ORDER BY tblCyberPlatCashTransfer.trans_datetime DESC");
                                        } elseif ($_SESSION['User_RoleID'] == 3) {
                                            $res = mysqli_query($db, "SELECT SUM(amount) as Total FROM tblCyberPlatCashTransfer INNER JOIN tblRetailer ON tblCyberPlatCashTransfer.kioskid = tblRetailer.kioskId INNER JOIN tblDistributor ON tblRetailer.DistributorID = tblDistributor.Id 
                                        WHERE tblDistributor.UserID = '$uid' " . $filterQry . " ORDER BY tblCyberPlatCashTransfer.trans_datetime DESC");
                                        } elseif ($_SESSION['User_RoleID'] == 4) {
                                            $res = mysqli_query($db, "SELECT SUM(amount) as Total FROM tblCyberPlatCashTransfer WHERE kioskid = (SELECT Kioskid FROM tblRetailer WHERE UserID = '$uid' " . $filterQry . " ) ORDER BY tblCyberPlatCashTransfer.trans_datetime DESC");
                                        }

                                        while ($row = mysqli_fetch_array($res)) {
                                        ?>
                                            <p style="font-weight: bold;">TOTAL : <?php echo $row["Total"]; ?></p>
                                                ...
                                                $('table').DataTable({
                                                    ...
                                                    buttons: [
                                                        ...
                                                        'csvHtml5',
                                                        {
                                                            ...
                                                            text: ' PDF ',
                                                            titleAttr: 'PDF',
                                                            messageBottom: 'TOTAL AMOUNT: '+<?php echo $row["Total"]; ?>
                                                        },
                                                        {
                                                            extend: 'excelHtml5',
                                                            title: this.title, 
                                        ...
                                        if (isset($_POST['Denoms'])) {
                                            ...
                                            $res = mysqli_query($db, "SELECT * FROM tblAcceptorCashAudit WHERE CashauditID = '$ID' ");
                                            while ($row = mysqli_fetch_array($res)) {
