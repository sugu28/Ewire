...
-->
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="BBPSBILLERS">
                        <ul class="nav flex-column sub-menu">
                            ...
                            <li class="nav-item"> <a class="nav-link" href="../../pages/BBPSBILLERS/DishTV.php">Dish TV</a></li><li class="nav-item"> <a class="nav-link" href="../../pages/BBPSBILLERS/Sundirect.php">Sundirect</a></li><li class="nav-item"> <a class="nav-link" href="../../pages/BBPSBILLERS/TataskyRetails.php">Tatasky Retails</a></li>
                            ...
                            <li class="nav-item"> <a class="nav-link" href="../../pages/BBPSBILLERS/TelecomMobilepostpaid.php">Telecom Mobile And Landline Post Paid Online</a></li>
               ...
               <li class="nav-item">
                    <a class="nav-link" href="../../../DMT_Dashboard/SBSR_Dashboard/pages/fastag/fastag.php">
                                    ...
                                    <table class="table" style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="text-align: center;">BB Mobile Recharge</th>
                                                <th style="text-align: center;">BB DTH Recharge</th>
                                                <th style="text-align: center;">BB Electricity Bill</th>
                                                <th style="text-align: center;">BB Corporation Tax</th>
                                                <th style="text-align: center;">Card Withdraw</th>
                                                <th style="text-align: center;">Cardless Withdraw</th>
                                                <th style="text-align: center;">AEPS</th>
                                                <th style="text-align: center;">FasTag</th>
                                                <th style="text-align: center;">WA Google Pay</th>
                                                <th style="text-align: center;">WA Amazon Pay</th>
                                                <th style="text-align: center;">WA Paytm</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                        ...
                        ?> 
                                            <tr>
                                                ...
                                                <td style="text-align: center;"><?php echo $row["TID"];?></td>
                                                 <td style="text-align: center;"><?php echo $row["cardFirstSixDigits"];?></td>
                                                <td style="text-align: center;"><?php echo $row["kioskid"];?></td>
                                                <td style="text-align: center;"><?php echo $row["bcid"];?></td>
                                                 <td style="text-align: center;"><?php echo $row["MID"];?></td>
                                                <td style="text-align: center;"><?php echo $row["TID"];?></td>
