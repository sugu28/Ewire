...
<head>
    ...
    <title>Commission Charges</title>
    <!-- Tables -->
                                    ...
                                    <table class="table" style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="text-align: center;">Trans_From</th>
                                                <th style="text-align: center;">Trans_From_ID</th>
                                                <th style="text-align: center;">Trans_To</th>
                                                <th style="text-align: center;">Trans_To_ID</th>
                                                <th style="text-align: center;">Amount</th>
                                                <th style="text-align: center;">Cyber_ID</th>

                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php $ret = mysqli_query($db, "select * from tbl_commission_charges");
                                            $cnt = 1;
                                            while ($row = mysqli_fetch_array($ret)) { ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;"><?php echo $row["Trans_From_ID"]; ?></td>
                                                    <td style="text-align: center;"><?php echo $row["Trans_To"]; ?></td>
                                                    <td style="text-align: center;"><?php echo $row["Trans_To_ID"]; ?></td>
                                                    <td style="text-align: center;"><?php echo $row["Amount"]; ?></td>
                                                    <td style="text-align: center;"><?php echo $row["Cyber_ID"]; ?></td>
