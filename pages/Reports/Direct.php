                                    ...
                                    <table class="table" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            if ($_SESSION['User_RoleID'] == 1) {
                                                ...
                                                $res = mysqli_query($db, "SELECT * FROM tblCyberPlatCashTransfer WHERE kioskid = (SELECT Kioskid FROM tblRetailer WHERE UserID = '$uid') AND (TransferStatus='Transaction Successful' OR TransferStatus='Success') " . $filterQry . " ORDER BY tblCyberPlatCashTransfer.trans_datetime DESC");
                                            }
