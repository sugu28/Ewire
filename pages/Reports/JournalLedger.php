                                    ...
                                    <table class="table" style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="text-align: center;">Credit OR Debit</th>
                                                <th style="text-align: center;">SPLIT</th>
                                                <th style="text-align: center;">TDS</th>
                                                <th style="text-align: center;">Balance</th>
                                                <th style="text-align: center;">Transaction Type</th>
                                                <th style="text-align: center;">Cash Audit ID</th>
                                        ...
                                        <tbody>
                                            ...
                                            if ($_SESSION['User_RoleID'] == 1) {
                                                $res = mysqli_query($db, "SELECT * FROM tbl_Journal_Ledger " . $filterQry . "ORDER BY tblBeneficiaryList.Trans_datetime DESC");
                                            } elseif ($_SESSION['User_RoleID'] == 2) {
                                                $res = mysqli_query($db, "SELECT *,tbl_Journal_Ledger.Id FROM tbl_Journal_Ledger INNER JOIN tblRetailer ON tblRetailer.kioskId = tbl_Journal_Ledger.Kioskid INNER JOIN tblMasterDistributor ON tblRetailer.MasterDistributorID = tblMasterDistributor.Id WHERE  tblMasterDistributor.UserID = '$uid' " . $filterQry . " ORDER BY tbl_Journal_Ledger.Id DESC");
                                            } elseif ($_SESSION['User_RoleID'] == 3) {
                                                $res = mysqli_query($db, "SELECT *,tbl_Journal_Ledger.Id FROM tbl_Journal_Ledger INNER JOIN tblRetailer ON tblRetailer.kioskId = tbl_Journal_Ledger.Kioskid INNER JOIN tblDistributor ON tblRetailer.DistributorID = tblDistributor.Id WHERE  tblDistributor.UserID = '$uid' " . $filterQry . "ORDER BY tbl_Journal_Ledger.Trans_datetime DESC");
                                            } elseif ($_SESSION['User_RoleID'] == 4) {
                                                $res = mysqli_query($db, "SELECT *,tbl_Journal_Ledger.Id FROM tbl_Journal_Ledger where Kioskid='$kioID' " . $filterQry . "ORDER BY tbl_Journal_Ledger.Trans_datetime DESC ");
                                            }
                                            ...
                                            while ($row = mysqli_fetch_array($res)) { ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;"><?php echo $row["beneficiary_Phone"]; ?></td>
                                                    <td style="text-align: center;"><?php echo $row["beneficiary_Name"]; ?></td>
                                                    <td style="text-align: center;"><?php echo $row["beneficiary_account_No"]; ?></td>
                                                    <td style="text-align: center;"><?php echo $row["trans_amount"]; ?></td>
                                                    <td style="text-align: center;"><?php echo $row["Credit_OR_Debit"]; ?></td>
                                                    <?php if ($row["Credit_OR_Debit"] == "DEBIT") {
                                                        $cnt = Ceil($row["trans_amount"] / 5000);
                                                    } ?>
                                                    <?php if ($row["Credit_OR_Debit"] == "CREDIT") {
                                                        $cnt = 0;
                                                    } ?>
                                                    <td style="text-align: center;"><?php echo $cnt; ?></td>
                                                    <td style="text-align: center;"><?php echo $row["TDS"]; ?></td>
                                                    <td style="text-align: center;"><?php echo $row["balance"]; ?></td>
                                                    <td style="text-align: center;"><?php echo $row["transaction_type"]; ?></td>
                                                    <td style="text-align: center;"><?php echo $row["cashauidit_id"]; ?></td>
                                                </tr>
                                            <?php
                                            }
                                            ?>
