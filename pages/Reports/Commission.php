...
<head>
    ...
    <title>Commission Charges History</title>
    <!-- Tables -->
                                    ...
                                    <table class="table" style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="text-align: center;">Trans_Amount_From</th>
                                                <th style="text-align: center;">Trans_Amount_To</th>
                                                <th style="text-align: center;">DMT_Charges</th>
                                                <th style="text-align: center;">Dist_Com</th>
                                                <th style="text-align: center;">KIOSK_Com</th>
                                                <th style="text-align: center;">DMT_Charges_IN</th>
                                        ...
                                        <tbody>
                                            ...
                                            $ret = mysqli_query($db, "SELECT tbl_Commission.*,tblRetailer.kioskId,FullName FROM tbl_Commission INNER JOIN tblRetailer ON tbl_Commission.RetailerID = tblRetailer.Id " . $filterQry . " ORDER BY tbl_Commission.Created_Date DESC");
                                            $cnt = 1;
                                            while ($row = mysqli_fetch_array($ret)) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;"><?php echo $row["Trans_Amount_From"]; ?></td>
                                                    <td style="text-align: center;"><?php echo $row["Trans_Amount_To"]; ?></td>
                                                    ...
                                                    <td style="text-align: center;"><?php echo $row["DMT_Charges_IN"]; ?></td>
