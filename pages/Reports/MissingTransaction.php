...
<head>
    ...
    <title>Missing Transactions</title>
    <!-- Tables -->
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="Reports">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <li class="nav-item"> <a class="nav-link" href="Direct.php">All Bank Cash Deposit</a></li>
                                <!--
...
-->
                                <?php if ($_SESSION['User_RoleName'] == 'Super Admin' || $_SESSION['User_RoleName'] == 'Master Distributor') {  ?> <li class="nav-item"> <a class="nav-link" href="Commission.php">Commission History</a></li>
                                <?php                 }                 ?>
                                <li class="nav-item"> <a class="nav-link" href="BeneficiaryList.php">Beneficiary List </a></li>
                                <li class="nav-item"> <a class="nav-link" href="CommissionDetails.php">Commission Details </a></li>
                                <li class="nav-item"> <a class="nav-link" href="JournalLedger.php">Journal Ledger </a></li>
                                <li class="nav-item"> <a class="nav-link" href="CashInMachine.php">Cash In Machine </a></li>
                                <li class="nav-item"> <a class="nav-link" href="DaywiseSplit.php">Daywise Split </a></li>
                                <li class="nav-item"> <a class="nav-link" href="MissingTransaction.php">Missing Transaction </a></li>
                            </ul>
                        </div>
                    </li>
                                    ...
                                    <table class="table" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            if ($_SESSION['User_RoleID'] == 1) {
                                                ...
                                                $res = mysqli_query($db, "SELECT * FROM tbl_Transaction_Status INNER JOIN tblRetailer ON tbl_Transaction_Status.kioskid = tblRetailer.kioskID
                                                INNER JOIN tblMasterDistributor ON tblRetailer.MasterDistributorID = tblMasterDistributor.Id WHERE tblMasterDistributor.UserID = '$uid' 
                                                AND Is_note_accepted = '1' AND Is_yapay_done = '1' AND (Is_trans_done = '0' OR Is_journal_done = '0') AND Is_trans_failed='0'
                                                ORDER BY tbl_Transaction_Status.trans_datetime DESC");
                                                ...
                                                <tr>
                                                    ...
                                                    <?php if ($_SESSION['User_RoleID'] == 2) { ?>
                                                        <td style="text-align: center;">
                                                            <button name="Submit" class='btn-edit btn btn-square btn-sm btn-outline-success btn-icon-text' value=""> SUBMIT </button>
                                                        </td>
                                                    <?php } ?>
                                                </tr>
                                            <?php
