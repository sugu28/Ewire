...
if (isset($_POST['Register'])) {
    ...
    if ($otpText == $_SESSION['otp']) {
        ...
        if ($_SESSION['Edit'] == null) {
            $query2 = "SELECT UserName from `tblSubDistributor` WHERE UserName='$Username' ";
            ...
            if (mysqli_num_rows($res) > 0) {
             ...
             VALUES ('$Username','$FullName','$ShopName','$BCID','$Address1','$DebitCardReaderNo','$GSTNo','$AAdhar','$Panno','$CPUID','$DOB', '$Password','$Mobile','$Userrole','1','$Address1','$State','$Address2','$Postcode','$City','$Country','$User_ID')";
                ...
                if ($rest) {
                    ...
                    $query1   = "INSERT into `tblSubDistributor` (UserID,UserName,FullName,ShopName,BCID,Location,DebitCardReaderNo,GSTNo,AAdhar,Panno,CPUID,DOB,Password,Phone,FkRoleID,IsActive,Address1,State,Address2,Postcode,City,Country,MasterDistributorID,CreatedUserId)
            ...
            $query1   = "UPDATE `tblSubDistributor` SET UserName = '$Username',FullName = '$FullName',ShopName = '$ShopName' ,BCID = '$BCID',Location = '$Address1',DebitCardReaderNo = '$DebitCardReaderNo',GSTNo = '$GSTNo',AAdhar = '$AAdhar',Panno = '$Panno',CPUID = '$CPUID',DOB = '$DOB',
