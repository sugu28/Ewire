...
-->
    ...
    WHERE kioskDetail.UserId = '$uid' AND kioskDetail.IsActive = 1 " . $filterQry . " ORDER BY tblCyberPlatCashTransfer.trans_datetime DESC");
                                                ...
                                                $res = mysqli_query($db, "SELECT * FROM tbl_Internet_Service WHERE kioskid = (SELECT Kioskid FROM tblMasterDistributor WHERE UserID = '$uid'" . $filterQry . ")");
    ...
    WHERE tblDistributor.UserID = '$uid' " . $filterQry . " ORDER BY tblCyberPlatCashTransfer.trans_datetime DESC");
                                                ...
                                                $res = mysqli_query($db, "SELECT * FROM tbl_Internet_Service WHERE kioskid = (SELECT Kioskid FROM tblRetailer WHERE UserID = '$uid'" . $filterQry . ")");
                                            }
