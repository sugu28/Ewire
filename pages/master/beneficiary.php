...
<head>
    ...
    <title>Remitter Beneficiary List</title>
    <!-- Tables -->
                ...
                <div class="content-wrapper">
                    <div class="page-header">
                        <h3 class="page-title" style="color:#9435f3">
                            ...
                            Remitter Beneficiary List
                        </h3>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <a href="../../dashboard.php"><input type="submit" name="SubmitOTP" value="Back" class="btn btn-Primary" style="background-color: #a15bff;color: white;" /></a>
                                    ...
                                    <table class="table" style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="text-align: center;">Bene IFSC</th>
                                                <th style="text-align: center;">Bene Bankname</th>
                                                <!-- <th style="text-align: center;">Bene BankBranch</th>
                                                <th style="text-align: center;">Bene BankDistrict</th>
                                                <th style="text-align: center;">Bene BankState</th> -->
                                                <th style="text-align: center;">Bene Phone</th>
...
$filterQry = '';
                                            ...
                                            if (isset($_GET['from_date']) && isset($_GET['to_date'])) {
                                                ...
                                                $filterQry = "AND createddatetime BETWEEN '$from_date' AND '$to_date'";
                                            }

                                            if ($_SESSION['User_RoleID'] == 1) {
                                                $res = mysqli_query($db, "SELECT * FROM tblBeneficiaryList ");
                                            } elseif ($_SESSION['User_RoleID'] == 2) {
                                                $res = mysqli_query($db, "SELECT * FROM tblBeneficiaryList INNER JOIN tblRetailer ON tblRetailer.kioskId = tblBeneficiaryList.kioskid INNER JOIN tblMasterDistributor ON tblRetailer.MasterDistributorID = tblMasterDistributor.Id
                                                WHERE  tblMasterDistributor.UserID = '$uid' ORDER BY tblBeneficiaryList.createddatetime DESC ");
                                            }
                                            while ($row = mysqli_fetch_array($res)) { ?>
                                                <tr>
                                                    ...
                                                    <!--  <td style="text-align: center;"><?php echo $row["beneficiaryid"]; ?></td>-->
                                                    ...
                                                    <td style="text-align: center;"><?php echo $row["benebankdistrict"]; ?></td>
                                                    <td style="text-align: center;"><?php echo $row["benebankstate"]; ?></td> -->
