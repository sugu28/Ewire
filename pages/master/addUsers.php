...
if ($_GET['Edit'] != null) {
    ...
    if ($_SESSION['Edit'] == 1) {
        ...
        $AEPS = $_GET['AEPS'];
        // $POA = $_GET['POA'];
        $POAReferenceNo = $_GET['POAReferenceNo'];
        //        $FMCG = $_GET['FMCG'];
...
-->
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <!-- <h2 class="card-title" style="text-align: center;color:#b66dff">ADD RETAILERS</h2> -->
                                    <br>
                                    <br>
                                    <form class="form" action="addUsers.php" method="post">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="FullName" name="FullName" value="<?php echo $fullname; ?>" placeholder="Full Name" required autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="ShopName" name="ShopName" value="<?php echo $shopname; ?>" onkeypress="return Validate(event);" placeholder="Shop Name" required autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="BCID" name="BCID" value="<?php echo $bcid; ?>" placeholder="BCID" onkeypress="return event.charCode >= 48 && event.charCode <= 57" required autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="mobile" name="mobile" value="<?php echo $phone; ?>" placeholder="mobile" maxlength="10" onkeypress="return event.charCode >= 48 && event.charCode <= 57" required autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-sm-3 col-form-label ">Debit Card Reader No</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="DebitCardReaderNo" name="DebitCardReaderNo" value="<?php echo $debitcard; ?>" placeholder="Debit Card Reader" onkeypress="return event.charCode >= 48 && event.charCode <= 57" autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="GSTNo" name="GSTNo" value="<?php echo $gst; ?>" placeholder="GST No" onkeypress="return event.charCode >= 48 && event.charCode <= 57" autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-sm-3 col-form-label mandatory">Aadhar No/POI</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="AAdhar" name="AAdhar" value="<?php echo $adhar; ?>" placeholder="AadharNo" maxlength="12" onkeypress="return event.charCode >= 48 && event.charCode <= 57" required autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="Panno" name="Panno" value="<?php echo $pan; ?>" placeholder="Pan No" maxlength="10" required autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-sm-3 col-form-label ">CPU ID </label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="CPUID" name="CPUID" value="<?php echo $cpuid; ?>" placeholder="CPU ID" autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-sm-3 col-form-label ">Dispenser Type</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="Dispensertype" name="Dispensertype" value="<?php echo $dispenser ?>" placeholder="Dispenser Type" autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-sm-3 col-form-label ">Acceptor Type</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="AcceptorType" name="AcceptorType" value="<?php echo  $acceptor ?>" placeholder="Acceptor Type" autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select class="form-select" id="MasterDistributor" name="MasterDistributor" required>
                                                            <option selected>-- select Master Distributor --</option>
                                                            <?php
                                                            $res = mysqli_query($db, "SELECT Id,FullName FROM tblMasterDistributor WHERE IsActive = 1 ");
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="password" class="form-control" id="Password" name="Password" value="<?php echo $password; ?>" placeholder="Password" required autocomplete="off" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-sm-3 col-form-label mandatory">Kiosk ID</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="kioskId" name="kioskId" value="<?php echo $kiosk; ?>" placeholder="Kisok ID" required autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-sm-3 col-form-label mandatory">Date Of Birth / Establishment Date</label>
                                                    <div class="col-sm-9">
                                                        <input type="date" class="form-control" id="DOB" placeholder="DOB" value="<?php echo $dob; ?>" name="DOB" required autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-sm-3 col-form-label ">Nature of Business</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="NatureofBusiness" placeholder="Nature of Business" value="<?php echo $NatureofBusiness; ?>" name="NatureofBusiness" autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-sm-3 col-form-label ">AEPS</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="AEPS" placeholder="AEPS" value="<?php echo $AEPS; ?>" name="AEPS" autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-sm-3 col-form-label mandatory">POA</label>
                                                    <div class="col-sm-9">
                                                        <select class="form-select" name="POA" id="POA">
                                        ...
                                        <!--
                                            <div class="col-md-6" >
                                                <div class="form-group row">
                                                    <label class="col-sm-3 col-form-label mandatory">FMCG</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="FMCG" placeholder="FMCG" value="<?php echo $FMCG; ?>" name="FMCG" required autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
-->
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-sm-3 col-form-label mandatory ">POA Reference No</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="POAReferenceNo" placeholder="POA Reference No" value="<?php echo $POAReferenceNo; ?>" name="POAReferenceNo" required autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="Address1" name="Address1" value="<?php echo $address1; ?>" placeholder="Address" required autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="State" name="State" value="<?php echo $state; ?>" placeholder="State" required autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="Address2" name="Address2" value="<?php echo $address2; ?>" placeholder="Address" required autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-sm-3 col-form-label mandatory">Pincode</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="Postcode" name="Postcode" value="<?php echo $postcode; ?>" placeholder="Pincode" onkeypress="return event.charCode >= 48 && event.charCode <= 57" required autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="City" name="City" value="<?php echo $city; ?>" placeholder="City" required autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
...
<script>
    ...
    //            if (!(inputValue >= 65 && inputValue <= 120) && (inputValue != 3 && inputValue != 0)) {
    //                event.preventDefault();
    //            }
    //        });
    //    });

    $(document).on('keypress', '#FullName', '#ShopName', function(event) {
...
<script>
    ...
    function GetOTP(Parameter) {
        ...
        document.getElementById("Dispensertype").value = ParameterArray[10];
        document.getElementById("AcceptorType").value = ParameterArray[11];
        //document.getElementById("distributor").value = ParameterArray[12];
        document.getElementById("MasterDistributor").value = ParameterArray[12];
        document.getElementById("DOB").value = ParameterArray[13];
        document.getElementById("NatureofBusiness").value = ParameterArray[14];
        document.getElementById("AEPS").value = ParameterArray[15];
        document.getElementById("POA").value = ParameterArray[16];
        document.getElementById("POAReferenceNo").value = ParameterArray[17];
        //document.getElementById("FMCG").value = ParameterArray[17];
        document.getElementById("Password").value = ParameterArray[18];
        document.getElementById("kioskId").value = ParameterArray[19];
        document.getElementById("Address1").value = ParameterArray[20];
        document.getElementById("State").value = ParameterArray[21];
        document.getElementById("Address2").value = ParameterArray[22];
        document.getElementById("Postcode").value = ParameterArray[23];
        document.getElementById("City").value = ParameterArray[24];
        document.getElementById("Country").value = ParameterArray[25];
...
if (isset($_POST['SubmitOTP'])) {
    ...
    $CPUID = $_POST["CPUID"];
    $Dispensertype = $_POST["Dispensertype"];
    $AcceptorType = $_POST["AcceptorType"];
    ...
    $AEPS = $_POST["AEPS"];
    $POA = $_POST["POA"];
    $POAReferenceNo = $_POST["POAReferenceNo"];
    //    $FMCG = $_POST["FMCG"];
    ...
    $Parameter = "'" . $FullName . "," . $ShopName . "," . $BCID . "," . $mobile . "," . $DebitCardReaderNo . "," . $GSTNo . "," . $AAdhar . "," . $Panno . "," . $Username . "," . $CPUID . "," . $Dispensertype . "," . $AcceptorType  . "," . $MasterDist . "," . $DOB . "," . $NatureofBusiness . "," .  $AEPS . "," . $POA  . "," . $POAReferenceNo . "," . $Password . "," . $kioskId . "," . $Address1 . "," . $State . "," . $Address2 . "," . $Postcode . "," . $City . "," . $Country . "'";
...
if (isset($_POST['Register'])) {
    ...
    if ($otpText == $_SESSION['otp']) {
        ...
        $Dispensertype = mysqli_real_escape_string($db, $_POST["Dispensertype"]);
        $AcceptorType = mysqli_real_escape_string($db, $_POST["AcceptorType"]);
        // $Userrole = mysqli_real_escape_string($db, $_POST["Userrole"]);
        $Userrole = 4; //Id = 3 for Retailer
        ...
        $NatureofBusiness = mysqli_real_escape_string($db, $_POST["NatureofBusiness"]);
        $AEPS = mysqli_real_escape_string($db, $_POST["AEPS"]);
        $POA = mysqli_real_escape_string($db, $_POST["POA"]);
        $POAReferenceNo = mysqli_real_escape_string($db, $_POST["POAReferenceNo"]);

        //    $FMCG = mysqli_real_escape_string($db, $_POST["FMCG"]);
        $Password = mysqli_real_escape_string($db, $_POST["Password"]);
        $kioskId = mysqli_real_escape_string($db, $_POST["kioskId"]);
        ...
        if ($_SESSION['Edit'] == null) {
            $query = "select * from tblRetailer where UserName='$Username'";
            $res = mysqli_query($db, $query);
            if (mysqli_num_rows($res) > 0) {
                echo "<script>oops();</script>";
            } else {

                $query    = "INSERT into `users` (UserName,FullName,ShopName,BCID,Location,DebitCardReaderNo,GSTNo,AAdhar,Panno,CPUID,Dispensertype,AcceptorType,DOB,NatureofBusiness,AEPS,POA,POAReferenceNo,Password,Phone,FkRoleID,IsActive,kioskId,Address1,State,Address2,Postcode,City,Country,CreatedUserId)
            VALUES ('$Username','$FullName','$ShopName','$BCID','$Address1','$DebitCardReaderNo','$GSTNo','$AAdhar','$Panno','$CPUID','$Dispensertype','$AcceptorType','$DOB','$NatureofBusiness','$AEPS','$POA', '$POAReferenceNo','$Password','$Mobile','$Userrole','1','$kioskId','$Address1','$State','$Address2','$Postcode','$City','$Country','$User_ID')";
                ...
                if ($result) {
                    ...
                    $query1    = "INSERT into `tblRetailer` (UserID,UserName,FullName,ShopName,BCID,Location,DebitCardReaderNo,GSTNo,AAdhar,Panno,CPUID,Dispensertype,AcceptorType,DOB,NatureofBusiness,AEPS,POA,POAReferenceNo,Password,Phone,FkRoleID,IsActive,kioskId,Address1,State,Address2,Postcode,City,Country,MasterDistributorID,CreatedUserId)
            VALUES ('$NewUserID','$Username','$FullName','$ShopName','$BCID','$Address1','$DebitCardReaderNo','$GSTNo','$AAdhar','$Panno','$CPUID','$Dispensertype','$AcceptorType','$DOB','$NatureofBusiness','$AEPS','$POA', '$POAReferenceNo','$Password','$Mobile','$Userrole','1','$kioskId','$Address1','$State','$Address2','$Postcode','$City','$Country','$MasterDist','$User_ID')";
                    $result   = mysqli_query($db, $query1);
                    if ($result) {

                        // register message
                        $reg = mysqli_query($db, "SELECT Phone from tblMasterDistributor where tblMasterDistributor.Id='$MasterDist' union select Phone from tblDistributor where tblDistributor.Id='$Distributor' ");
                        while ($row = mysqli_fetch_array($reg)) {
                            $mastMobile = $row['Phone'];
                            $DistMobile = $row['Phone'];
                        }

                        $numb = array($Mobile);
                        // $ottp = (string)mt_rand(1000,9999)      , $mastMobile, $DistMobile;
                        $REF_ID = (string)mt_rand(36523462, 99999999);
                        // $fourRandomDigit ="OTP : ".$ottp;
                        $uid = 'sbsrkannam';
                        $pwd = urlencode('9180');
                        ...
                        echo "<script>location.href='addUsers.php';</script>";
                    }
                } else {
            ...
            $query1   = "UPDATE `tblRetailer` SET UserName = '$Username',FullName = '$FullName',ShopName = '$ShopName' ,BCID = '$BCID',Location = '$Address1',DebitCardReaderNo = '$DebitCardReaderNo',GSTNo = '$GSTNo',AAdhar = '$AAdhar',Panno = '$Panno',CPUID = '$CPUID',Dispensertype='$Dispensertype',AcceptorType = '$AcceptorType',DOB = '$DOB',NatureofBusiness = '$NatureofBusiness',AEPS = '$AEPS',POA = '$POA',POAReferenceNo = '$POAReferenceNo',
            ...
            if ($result1) {
                $query2   = "UPDATE `users` SET UserName = '$Username',FullName = '$FullName',ShopName = '$ShopName' ,BCID = '$BCID',Location = '$Address1',DebitCardReaderNo = '$DebitCardReaderNo',GSTNo = '$GSTNo',AAdhar = '$AAdhar',Panno = '$Panno',CPUID = '$CPUID',Dispensertype='$Dispensertype',AcceptorType = '$AcceptorType',DOB = '$DOB',NatureofBusiness = '$NatureofBusiness',AEPS = '$AEPS',POA = '$POA',POAReferenceNo = '$POAReferenceNo',
