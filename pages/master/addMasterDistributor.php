...
<head>
    ...
    <title>add master distributor</title>
    <!-- plugins:css -->
...
-->
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <!-- <h2 class="card-title" style="text-align: center;color:#b66dff">ADD MASTER DISTRIBUTORS</h2> -->
                                    <br>
                                    <br>
                                    <form class="form" action="addMasterDistributor.php" method="post">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-sm-3 col-form-label mandatory">Full Name</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="FullName" name="FullName" value="<?php echo $fullname; ?>" onkeydown="return /[a-z]/i.test(event.key)" required placeholder="Full Name" autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="mobile" name="mobile" value="<?php echo $phone; ?>" maxlength="10" placeholder="mobile" onkeypress="return event.charCode >= 48 && event.charCode <= 57" required autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="DebitCardReaderNo" name="DebitCardReaderNo" id="DebitCardReaderNo" value="<?php echo $debitcard; ?>" onkeypress="return event.charCode >= 48 && event.charCode <= 57" required placeholder="Debit Card Reader" autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="GSTNo" name="GSTNo" placeholder="GST No" value="<?php echo $gst; ?>" onkeypress="return event.charCode >= 48 && event.charCode <= 57" autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="AAdhar" name="AAdhar" placeholder="AadharNo" value="<?php echo $adhar; ?>" onkeypress="return event.charCode >= 48 && event.charCode <= 57" required autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="CPUID" name="CPUID" placeholder="CPU ID" value="<?php echo $cpuid; ?>" required autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="password" class="form-control" id="Password" name="Password" placeholder="Password" value="<?php echo $password; ?>" required autocomplete="off" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="date" class="form-control" id="DOB" placeholder="dd/mm/yyyy" name="DOB" value="<?php echo $dob; ?>" required autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="Address1" name="Address1" placeholder="Address" value="<?php echo $address1; ?>" required autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="State" name="State" placeholder="State" value="<?php echo $state; ?>" required autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="Address2" name="Address2" placeholder="Address" value="<?php echo $address2; ?>" required autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="Postcode" name="Postcode" placeholder="Postcode" value="<?php echo $postcode; ?>" required autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="City" name="City" placeholder="City" value="<?php echo $city; ?>" required autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div id="myModal" class="modal">
                                            <div class="modal-content">
                                                ...
                                                <div class="input-group mb-2" id="otpShow1">
                                                    ...
                                                    <input id="OTP" name="OTP" type="text" class="form-control" placeholder="OTP" maxlength="4" onkeypress="return event.charCode >= 48 && event.charCode <= 57" style="font-weight:bold" autocomplete="off">
                                                    <input type="submit" name="Register" class="btn btn-info" style="width:20%;height: 49px;" id="btnOtp" value="Submit" />
                                                </div>
...
<script type="text/javascript">
    ...
    function GetOTP(Parameter) {
        ...
        document.getElementById("DOB").value = ParameterArray[10];
        document.getElementById("Password").value = ParameterArray[11];
        document.getElementById("Address1").value = ParameterArray[12];
        document.getElementById("State").value = ParameterArray[13];
        document.getElementById("Address2").value = ParameterArray[14];
        document.getElementById("Postcode").value = ParameterArray[15];
        document.getElementById("City").value = ParameterArray[16];
        document.getElementById("Country").value = ParameterArray[17];
...
if (isset($_POST['SubmitOTP'])) {
    ...
    // echo '<script type="text/javascript"> document.getElementById("FullName").value = '.$FullName.');</script>';

    // echo '<script type="text/javascript">GetOTP('.$DebitCardReaderNo.','.$FullName.','.$ShopName.','.$BCID.','.$mobile.','.$GSTNo.','.$AAdhar.','.$Panno.','.$Username.','.$CPUID.','.$DOB.','.$Password.','.$Address1.','.$State.','.$Address2.','.$Postcode.','.$City.','.$Country.');</script>';
}
...
if (isset($_POST['Register'])) {
    ...
    if ($otpText == $_SESSION['otp']) {
        ...
        if ($_SESSION['Edit'] == null) {
            ...
            $query = "SELECT UserName FROM `tblMasterDistributor` WHERE UserName='$Username' ";
            ...
            VALUES ('$Username','$FullName','$ShopName','$BCID','$Address1','$DebitCardReaderNo','$GSTNo','$AAdhar','$Panno','$CPUID','$DOB', '$Password','$Mobile','$Userrole','1','$Address1','$State','$Address2','$Postcode','$City','$Country','$User_ID')";
                ...
                if ($result) {
                    ...
                    $query1   = "INSERT into `tblMasterDistributor` (UserID,UserName,FullName,ShopName,BCID,Location,DebitCardReaderNo,GSTNo,AAdhar,Panno,CPUID,DOB,Password,Phone,FkRoleID,IsActive,Address1,State,Address2,Postcode,City,Country,CreatedUserId)
                VALUES ('$NewUserID','$Username','$FullName','$ShopName','$BCID','$Address1','$DebitCardReaderNo','$GSTNo','$AAdhar','$Panno','$CPUID','$DOB', '$Password','$Mobile','$Userrole','1','$Address1','$State','$Address2','$Postcode','$City','$Country','$User_ID')";
                    ...
                    if ($result) {
                        ...
                        echo "<script>location.href='addMasterDistributor.php';</script>";
                    } else {
            ...
            $query1   = "UPDATE `tblMasterDistributor` SET UserName = '$Username',FullName = '$FullName',ShopName = '$ShopName' ,BCID = '$BCID',Location = '$Address1',DebitCardReaderNo = '$DebitCardReaderNo',GSTNo = '$GSTNo',AAdhar = '$AAdhar',Panno = '$Panno',CPUID = '$CPUID',DOB = '$DOB',
                        Password = '$Password',Phone = '$Mobile',FkRoleID = '$Userrole',Address1 = '$Address1',State = '$State',Address2 = '$Address2',Postcode = '$Postcode',City = '$City',Country ='$Country',ModifiedUserId='$User_ID' WHERE  UserID='$NewUserID' ";
