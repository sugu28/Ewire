            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="page-header">
                        ...
                        COMMISSION RECEIVED </h3>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                               <!-- <li class="breadcrumb-item"><a href="#">TRANSACTIONS</a></li>-->
                                <li class="breadcrumb-item active" aria-current="page"> COMMISSION RECEIVED </li>
                            </ol>
                        </nav>
                    </div>
                    <div class="row">
                                    ...
                                    <table class="table" style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="text-align: center;">DMS</th>
                                                <th style="text-align: center;">GLUCK</th>
                                                <th style="text-align: center;">KFW</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                   <?php 
