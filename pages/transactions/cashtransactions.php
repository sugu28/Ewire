        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                                    ...
                                    <table class="table" style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="text-align: center;">Routing Type</th>
                    ...
                    $res = mysqli_query($db,"select * from tblTempCashDeposit");
                    while ($row=mysqli_fetch_array($res)){
                        ?>
                                            <tr>
                                                <td style="text-align: center;"><?php echo $row["createddatetime"];?></td>
                                                <td style="text-align: center;"><?php echo $row["SD"];?></td>
                                                <td style="text-align: center;"><?php echo $row["AP"];?></td>
                                                <td style="text-align: center;"><?php echo $row["benemobile"];?></td>
                                                <td style="text-align: center;"><?php echo $row["RemitterID"];?></td>
                                                <td style="text-align: center;"><?php echo $row["RemitterMobileNo"];?></td>
