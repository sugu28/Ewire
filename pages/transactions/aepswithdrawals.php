        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                               <!-- <li class="breadcrumb-item"><a href="#">TRANSACTIONS</a></li>-->
                                <li class="breadcrumb-item active" aria-current="page">AEPS WITHDRAWALS</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="row">
                                    ...
                                    <table class="table" style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="text-align: center;">Benificiary ID</th>
                                                <th style="text-align: center;">Benificiary Name</th>
                    ...
                    $res = mysqli_query($db,"select * from tbl_aeps_trans_details");
                    while ($row=mysqli_fetch_array($res)){
                        ?>
                                            <tr>
                                                ...
                                                <td style="text-align: center;"><?php echo $row["errorForAgent"];?></td>
