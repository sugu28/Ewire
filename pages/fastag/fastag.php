...
<head>
    ...
    <title>Fasttag Recharge - IFSPL</title>
    <!-- Tables -->
                                    ...
                                    <table class="table" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            if ($_SESSION['User_RoleID'] == 1) {
                                                ...
                                                $res = mysqli_query($db, "SELECT * FROM tbl_Fastag_Recharge WHERE kioskid = (SELECT Kioskid FROM tblMasterDistributor WHERE UserID = '$uid' " . $filterQry . ")");
                                                ...
                                                $res = mysqli_query($db, "SELECT * FROM tbl_Fastag_Recharge WHERE kioskid = (SELECT Kioskid FROM tblRetailer WHERE UserID = '$uid' " . $filterQry . " )");
                                            }
