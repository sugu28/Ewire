                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="ui-basic">
                                <ul class="nav flex-column sub-menu">
                                    ...
                                    <li class="nav-item"> <a class="nav-link" href="../master/manageusers.php">Manage
                                            Users</a></li>
                                    <li class="nav-item"> <a class="nav-link" href="../master/kioskdetails.php">Kiosk
                                            Details</a></li>
                                    <?php if ($_SESSION['User_RoleName'] == 'Super Admin') { ?>
                                        <li class="nav-item"> <a class="nav-link" href="../master/addMasterDistributor.php">Add
                                                Master Distributor</a></li>
                                        <li class="nav-item"> <a class="nav-link" href="../master/addDistributors.php">Add
                                                Distributors </a></li>
                                            <li class="nav-item"> <a class="nav-link" href="../master/subDistributors.php">Sub Distributor</a>
                            </li>
                                    <?php } ?>
                                    <li class="nav-item"> <a class="nav-link" href="../master/addUsers.php">Add Users </a>
                                    </li>
...
-->
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="BBPSBILLERS">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <li class="nav-item"> <a class="nav-link" href="../../pages/BBPSBILLERS/Jio.php">Jio</a>
                                </li>
                                ...
                                <li class="nav-item"> <a class="nav-link" href="../../pages/BBPSBILLERS/DishTV.php">Dish
                                        TV</a></li>
                                ...
                                <li class="nav-item"> <a class="nav-link" href="../../pages/BBPSBILLERS/Gas.php">Gas</a>
                                </li>
                                <li class="nav-item"> <a class="nav-link" href="../../pages/BBPSBILLERS/Water.php">Water</a></li>
                                <li class="nav-item"> <a class="nav-link" href="../../pages/BBPSBILLERS/TelecomMobileAndLandline.php">Telecom Mobile And
                                        Landline Post Paid Online</a></li>
                                <li class="nav-item"> <a class="nav-link" href="../../pages/BBPSBILLERS/TelecomMobilepostpaid.php">Telecom Mobile And
                                        Landline Post Retails</a></li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="Internetserviceproviders">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="../../pages/master/Internetserviceproviders/Tikonabill.php">Tikona Bill
                                        Payment</a></li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="InsuranceBillPay">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <li class="nav-item"> <a class="nav-link" href="../../pages/InsuranceBillPay/BhartiAxaLifeInsurance.php">Bharti Axa Life
                                        Insurance</a></li>

                                <li class="nav-item"> <a class="nav-link" href="../../pages/InsuranceBillPay/IndiaFirstInsurance.php">India First
                                        Insurance</a></li>
                                    ...
                                    <table class="table" style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Kiosk ID</th>
                                                <th>Remitter ID</th>
                                                <th>Remitter Phone</th>
                                                <th>Transaction Type</th>
                                                <th>Transaction Date</th>
                                                <th>Transaction Ref. No.</th>
                                                <th>Total Amount</th>
                                                <th>Transaction (txn) Amount</th>
                                                <th>Transaction (txn) Charge</th>
                                        ...
                                        <tbody>
                                            ...
                                            if ($_SESSION['User_RoleID'] == 1) {
                                                ...
                                                WHERE kioskDetail.UserId = '$uid' AND kioskDetail.IsActive = 1 " . $filterQry . " ORDER BY tblCyberPlatCashTransfer.trans_datetime DESC");
                                            } elseif ($_SESSION['User_RoleID'] == 2) {
                                                $res = mysqli_query($db, "SELECT * FROM tbl_Insurance_BillPay WHERE kioskid = (SELECT Kioskid FROM tblMasterDistributor WHERE UserID = '$uid' " . $filterQry . ")");
                                                ...
                                                $res = mysqli_query($db, "SELECT * FROM tbl_Insurance_BillPay WHERE kioskid = (SELECT Kioskid FROM tblRetailer WHERE UserID = '$uid' " . $filterQry . ")");
                                            }
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;"><?php echo $row["TransactionType"]; ?></td>
                                                    <td style="text-align: center;"><?php echo $row["TransactionDate"]; ?></td>
                                                    <td style="text-align: center;"><?php echo $row["TransactionRef.No."]; ?></td>
                                                    <td style="text-align: center;"><?php echo $row["TotalAmount"]; ?></td>
                                                    <td style="text-align: center;"><?php echo $row["Transaction(txn)Amount"]; ?></td>
                                                    <td style="text-align: center;"><?php echo $row["Transaction(txn)Charges"]; ?></td>
                                                    <td style="text-align: center;"><?php echo $row["BeneficiaryPhoneNo."]; ?></td>
                                                    <td style="text-align: center;"><?php echo $row["BeneficiaryName"]; ?></td>
