...
-->
                                <?php if ($_SESSION['User_RoleName'] == 'Super Admin' || $_SESSION['User_RoleName'] == 'Master Distributor') {  ?> <li class="nav-item"> <a class="nav-link" href="../Reports/Commission.php">Commission History</a></li> <?php } ?>
                                    ...
                                    <table class="table" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            if (isset($_GET['from_date']) && isset($_GET['to_date'])) {
                                                ...
                                                $filterQry = "AND trans_datetime BETWEEN '$from_date' AND '$to_date'";
                                            }
                                            ...
                                            if ($_SESSION['User_RoleID'] == 1) {
                                                ...
                                                $res = mysqli_query($db, "SELECT * FROM tbl_BBPS_Billers WHERE kioskid = (SELECT Kioskid FROM tblMasterDistributor WHERE UserID = '$uid')");
                                                ...
                                                $res = mysqli_query($db, "SELECT * FROM tbl_BBPS_Billers WHERE kioskid = (SELECT Kioskid FROM tblRetailer WHERE UserID = '$uid')");
                                            }
                                            ...
                                            ?> <tr>
                                                    ...
                                                    <td style="text-align: center;"><?php echo $row["TransactionType"]; ?>
                                                    </td>
                                                    <td style="text-align: center;"><?php echo $row["TransactionDate"]; ?>
                                                    </td>
                                                    <td style="text-align: center;">
                                                        <?php echo $row["TransactionRef.No."]; ?></td>
                                                    <td style="text-align: center;"><?php echo $row["TotalAmount"]; ?></td>
                                                    <td style="text-align: center;">
                                                        <?php echo $row["Transaction(txn)Amount"]; ?></td>
                                                    <td style="text-align: center;">
                                                        <?php echo $row["Transaction(txn)Charges"]; ?></td>
                                                    <td style="text-align: center;">
                                                        <?php echo $row["BeneficiaryPhoneNo."]; ?></td>
                                                    <td style="text-align: center;"><?php echo $row["BeneficiaryName"]; ?>
                                                    </td>
                                                    <td style="text-align: center;"><?php echo $row["TransactionStatus"]; ?>
                                                    </td>
